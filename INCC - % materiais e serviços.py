...
page_url = 'https://www3.bcb.gov.br/sgspub/consultarvalores/consultarValoresSeries.do?method=consultarSeries&series=7462'
driver.get(page_url)
...
excel_file_path = r'C:\Users\rafaela.rabelo\Downloads\CDI\INCC - % materiais e serviços.xlsx'
