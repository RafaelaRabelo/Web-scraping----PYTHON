# %%
#SCRIPT QUE ENTRA NO SITE DO IBGE E BAIXA OS DADOS DO INPC DIARIAMENTE
...
page = requests.get('https://sidra.ibge.gov.br/tabela/1736')
driver.get("https://sidra.ibge.gov.br/tabela/1736")
...
button_pesquisar = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div[1]/div[4]/div[2]/div/div[2]/div[2]/div/div[1]/div[1]/div/button[2]')
button_pesquisar.click()
print("Botão 'RETIRAR' clicado.")
time.sleep(3)

# CLICAR NO BOTÃO DE SELECIONAR APENAS ÍNDICE GERAL
button_pesquisar = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div[1]/div[4]/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div/div/div[1]/div/div/div/button')
button_pesquisar.click()
...
caminho_destino = r"C:\Users\rafaela.rabelo\Downloads\CDI\INPC.xlsx"

# ABRIR O ARQUIVO E SALVAR NO EXCEL
file = pd.read_excel(caminho_arquivo)
file.to_excel(caminho_destino, sheet_name="INPC", index=False)
...
print("INPC TRANSFERIDO para", caminho_destino)
