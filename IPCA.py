# %%
#SCRIPT QUE ENTRA NO SITE DO IBGE E BAIXA OS DADOS DO IPCA DIARIAMENTE
...
page = requests.get('https://sidra.ibge.gov.br/tabela/1737')
driver.get("https://sidra.ibge.gov.br/tabela/1737")
...
caminho_destino = r"C:\Users\rafaela.rabelo\Downloads\CDI\IPCA.xlsx"

# ABRIR O ARQUIVO E SALVAR NO EXCEL
file = pd.read_excel(caminho_arquivo)
file.to_excel(caminho_destino, sheet_name="IPCA", index=False)
...
print("IPCA TRANSFERIDO para", caminho_destino)
